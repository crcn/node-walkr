...
module.exports = function(_source, _destination, _self) {
	...
	_self.filterDir = function(search, handler) {

		_addFilter('directory', search, handler);	
		return _self;
	...
	_self.filterFile = function(search, handler) {

		_addFilter('file', search, handler);	
		return _self;
	...
	_self.filter = function(search, handler) {

		_self.filterDir(search);
		return _self.filterFile(search, handler);
	...
	function _addFilter(type, search, handler) {
		...
		if(search instanceof RegExp) {
			...
			fn = {
				test: function(options, next) {
					...
					var matches = search.test(options.name);
